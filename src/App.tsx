...
const PageLoader = () => (
  <div className="h-full flex flex-col items-center justify-center">
    <div className="relative w-16 h-16">
      ...
      <div className="absolute inset-0 rounded-full border-4 border-t-purple-500 motion-safe:animate-spin"></div>
      <div className="absolute inset-4 rounded-full bg-purple-500/20 blur-sm motion-safe:animate-pulse"></div>
    </div>
    <div className="mt-4 text-slate-300 font-medium motion-safe:animate-pulse">Loading Workspace...</div>
  </div>
);
