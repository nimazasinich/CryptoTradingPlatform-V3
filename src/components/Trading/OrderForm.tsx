  ...
  return (
    <>
      <div className="glass-card p-5 h-full flex flex-col overflow-y-auto custom-scrollbar">
        ...
        {/* Order Type Tabs */}
        <div className="flex gap-6 text-sm font-medium text-slate-400 mb-5 px-1 shrink-0">
          <button 
        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1 flex flex-col">
          ...
          {orderType === 'stop-limit' && (
            <div className="space-y-1.5">
              <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Stop Price (USDT)</label>
          ...
          <div className="grid grid-cols-4 gap-2">
            {[25, 50, 75, 100].map(pct => (
              <button 
                ...
                className="bg-white/5 hover:bg-purple-500/20 hover:border-purple-500/50 border border-white/5 py-2 rounded-lg text-[10px] text-slate-300 font-bold transition-all"
              >
                {pct}%
              </button>
            ))}
          ...
          >
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowConfirmation(false)}
                  className="flex-1 py-2.5 rounded-lg bg-white/5 hover:bg-white/10 text-white font-bold transition-colors"
                >
                  Cancel
                </button>
                <button
